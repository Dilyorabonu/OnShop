function About() {
    return (
      <div className="p-8 bg-base-100 min-h-screen">
        ...
        <section className="mb-10 p-6 bg-base rounded-lg">
        ...
        <section className="p-6 bg-base rounded-lg">
          ...
          <p className="text-gray-500">
            We are committed to delivering exceptional value to our users. Our
            dedicated team works tirelessly to ensure that you have the best
            experience possible, with continuous updates and support.
          </p>
        </section>
      </div>
    );
